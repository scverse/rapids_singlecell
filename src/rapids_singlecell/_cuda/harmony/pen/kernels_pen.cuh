...
// ---- Fused penalty + normalize with size_t index ----
...
// ---- Fused penalty + normalize with int32 index ----
// Same as fused_pen_norm_kernel but with int* idx_in (for clustering mini-batch).
template <typename T>
__global__ void fused_pen_norm_kernel_int(const T* __restrict__ similarities,
                                          const T* __restrict__ penalty,
                                          const int* __restrict__ cats,
                                          const int* __restrict__ idx_in, T* __restrict__ R_out,
