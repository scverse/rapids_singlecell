...
template <typename T>
__global__ void qc_csc_kernel(const int* __restrict__ indptr, const int* __restrict__ index,
                              const T* __restrict__ data, T* __restrict__ sums_cells,
                              T* __restrict__ sums_genes, int* __restrict__ cell_ex,
...
template <typename T>
__global__ void qc_csr_kernel(const int* __restrict__ indptr, const int* __restrict__ index,
                              const T* __restrict__ data, T* __restrict__ sums_cells,
                              T* __restrict__ sums_genes, int* __restrict__ cell_ex,
...
template <typename T>
__global__ void qc_dense_kernel(const T* __restrict__ data, T* __restrict__ sums_cells,
                                T* __restrict__ sums_genes, int* __restrict__ cell_ex,
                                int* __restrict__ gene_ex, int n_cells, int n_genes) {
  int cell = blockDim.x * blockIdx.x + threadIdx.x;
...
template <typename T>
__global__ void qc_csc_sub_kernel(const int* __restrict__ indptr, const int* __restrict__ index,
                                  const T* __restrict__ data, T* __restrict__ sums_cells,
...
template <typename T>
__global__ void qc_csr_sub_kernel(const int* __restrict__ indptr, const int* __restrict__ index,
                                  const T* __restrict__ data, T* __restrict__ sums_cells,
...
template <typename T>
__global__ void qc_dense_sub_kernel(const T* __restrict__ data, T* __restrict__ sums_cells,
                                    const bool* __restrict__ mask, int n_cells, int n_genes) {
  int cell = blockDim.x * blockIdx.x + threadIdx.x;
  int gene = blockDim.y * blockIdx.y + threadIdx.y;
  if (cell >= n_cells || gene >= n_genes) return;
  if (!mask[gene]) return;
