...
def scrublet(
    ...
    *,
    ...
    :func:`~rapids-singlecell.pp.scrublet_simulate_doublets`, and run the core scrublet
    function :func:`~rapids-singlecell.pp.scrublet` with ``adata_sim`` set.
    ...
    adata_sim
        ...
        :func:`~rapids-singlecell.pp.scrublet_simulate_doublets`, with same number of vars
    ...
    log_transform
        Whether to use :func:`~rapids-singlecell.pp.log1p` to log-transform the data
        prior to PCA.
    mean_center
    ...
    See also
    --------
    :func:`~rapids-singlecell.pp.scrublet_simulate_doublets`: Run Scrublet's doublet
        simulation separately for advanced usage.
    :func:`~rapids-singlecell.pl.scrublet_score_distribution`: Plot histogram of doublet
...
def _scrublet_call_doublets(
    ...
    *,
    ...
    adata_obs
        ...
        :func:`~rapids-singlecell.pp.normalize_total` and filtered to include only highly
        variable genes.
    adata_sim
    ...
    mean_center
        If True, center the data such that each gene has a mean of 0.
        `cuml.decomposition.PCA` will be used for dimensionality
        reduction.
    normalize_variance
        If True, normalize the data such that each gene has a variance of 1.
        `cuml.decomposition.TruncatedSVD` will be used for dimensionality
        reduction, unless `mean_center` is True.
    n_prin_comps
        Number of principal components used to embed the transcriptomes prior
        to k-nearest-neighbor graph construction.
...
def scrublet_simulate_doublets(
    ...
    *,
    ...
    See also
    --------
    :func:`~rapids-singlecell.pp.scrublet`: Main way of running Scrublet, runs
