...
* 30.04.26 **v0.15.0 released!** This release ships precompiled CUDA kernels via [nanobind](https://github.com/wjakob/nanobind) — no CUDA toolkit needed at install time. Prebuilt wheels for x86_64 and aarch64 support CUDA 12 and 13, covering Turing through Blackwell GPUs. Install with `pip install rapids-singlecell-cu13` (or `-cu12`). See the [installation guide](installation.md) for details.
